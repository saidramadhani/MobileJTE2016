...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickSamaDengan(View view) {
        ...
        String numAngka1Str = numAngka1.getText().toString();
        int awal = Integer.valueOf(numAngka1Str);

        EditText numAngka2 = (EditText) findViewById(R.id.numAngka2);
        String numAngka2Str = numAngka2.getText().toString();
        int akhir = Integer.valueOf(numAngka2Str);
